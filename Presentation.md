...
========================================================
author: ABOOBACKER SIDHEEQ MACHINGAL
date: Thu Feb 08 08:10:50 2018
...
*[Shiny App]* - [https://idofabu.shinyapps.io/Wordpredictor/]
...
<span style="color:blue; font-weight:bold;font-size:0.7em">A Shiny application was developed based on the next word prediction model described previously as shown below. </span>
<img src="./Presentation-figure/Capture.PNG"></img>
